...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/-manas-choudhary-)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/manaspros)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:manas24102@iiitnr.edu.in)
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/the_never_ending_guy)

![Profile Views](https://komarev.com/ghpvc/?username=manaspros&color=blueviolet&style=for-the-badge&label=PROFILE+VIEWS)
...
```python
const manas = {
    role: "AI Engineer | Researcher | Full-Stack Developer",
    current_roles: {
        research: "IIT Roorkee - LLM Bias Mitigation & Multi-Agent Systems",
        ai_engineer: "Atlan - Scalable AI Infrastructure with MCP",
        rnd: "Samsung R&D - Figma-to-React AI Automation",
        sde: "Sigmoyd - No-Code AI Agent Platform"
    },
    education: "B.Tech DSAI @ IIIT Naya Raipur (2024-2028)",
    expertise: {
        ai_ml: [
            "🧠 Multi-Agent Systems (Red-teaming, Adversarial AI)",
            "🔧 Fine-tuning (LoRA, DeepSeek, Llama)",
            "🤖 AI Agents (CrewAI, LangChain, LangGraph, MCP)",
            "📊 RAG Systems (ChromaDB, FAISS, Neo4j)",
            "🎯 Production AI (Scalability, Security, Deployment)"
        ],
        engineering: [
            "💻 Full-Stack (React, Next.js, Node.js, FastAPI)",
            "🐳 DevOps (Docker, GCP, AWS, Vercel)",
            "📱 Mobile (React Native, Expo)",
            "🗄️ Databases (MongoDB, PostgreSQL, Neo4j)"
        ],
        research: [
            "🔬 Automated Bias Discovery in LLMs",
            "⚔️ Adversarial AI & Red-teaming",
            "🛡️ Real-time Bias Mitigation",
            "🎨 Design-to-Code Automation"
        ]
    },
    achievements: {
        hackathons: "🥇 1st @ IAM 2025 | 🥈 2nd @ E-Summit",
        research: "IIT Roorkee & IIT Jodhpur",
        impact: "70-80% reduction in manual coding time",
        leadership: "Dev Club activities & mentoring"
    },
    current_focus: "Building production-grade AI systems at scale",
...
🥇 **1st Place** - IAM 2025 Hackathon  
🥈 **2nd Place** - E-Summit Hackathon  
🔬 **Research** - IIT Roorkee (Feb 2026)  
🔬 **Research** - IIT Jodhpur (May-Jul 2025)  
💼 **AI Engineer** - Atlan (Jan 2026)  
💼 **R&D Intern** - Samsung (Oct 2025)  
...
**AI Automation:** 70-80% time reduction  
**Multi-Agent:** Red-teaming frameworks  
**Code Analysis:** AST-based semantic parsing  
**Design Systems:** Enterprise-scale automation  
**Platform:** No-code AI agent deployment  
**Research:** LLM bias mitigation  
